...
public class RecyclerPendingHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public RecyclerPendingHolder(View itemView, ItemClickCallback itemClickCallback) {
        super(itemView);
