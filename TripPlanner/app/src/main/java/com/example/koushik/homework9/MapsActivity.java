...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    private void method(LatLng origin, LatLng dest,String title) {
    ...
    public void onLocationChanged(Location location) {
        ...
        for(int i=0;i<locations.size();i++){
            builder.include(new LatLng(locations.get(i).getLat(),locations.get(i).getLng()));
        }
        ...
        for(int i=0;i<=locations.size();i++){
            ...
            if(i==0){
                ...
                dest=new LatLng(locations.get(i).getLat(),locations.get(i).getLng());
                method(origin,dest,"Current position");
            }
            else if(i==locations.size()){
                dest=new LatLng(mLastLocation.getLatitude(),mLastLocation.getLongitude());
                origin=new LatLng(locations.get(i-1).getLat(),locations.get(i-1).getLng());
                method(origin,dest,locations.get(i-1).getLocality());
            }else{
                origin=new LatLng(locations.get(i-1).getLat(),locations.get(i-1).getLng());
                dest=new LatLng(locations.get(i).getLat(),locations.get(i).getLng());
                method(origin,dest,locations.get(i-1).getLocality());
